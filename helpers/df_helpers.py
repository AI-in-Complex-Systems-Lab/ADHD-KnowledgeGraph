...
def graph2Df(nodes_list) -> pd.DataFrame:
    ...
    graph_dataframe["node_1_type"] = graph_dataframe["node_1_type"].apply(lambda x: str(x).lower())
    graph_dataframe["node_2"] = graph_dataframe["node_2"].apply(lambda x: str(x).lower())
    graph_dataframe["node_2_type"] = graph_dataframe["node_2_type"].apply(lambda x: str(x).lower())
